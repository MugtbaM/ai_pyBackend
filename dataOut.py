...
# data = {
#     'education': [
#         {'degree': 'Bachelor of Engineering', 'institute': 'UofK'},
#         {'degree': 'Master in Project Management', 'institute': 'MIT'}
#     ],
#     'experience': [
#         {'role': 'Engineer', 'startDate': '2025-03-01', 'endDate': '2025-03-02'},
#         {'role': 'PM', 'startDate': '2025-02-01', 'endDate': '2025-03-01'}
#     ],
#     'skills': ['Python', 'Management', 'Naruto']
# }

# result_text = create_text(data)
# print(result_text)
